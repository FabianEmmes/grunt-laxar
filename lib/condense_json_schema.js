...
var FORBIDDEN_PROPERTIES = [ 'additionalItems', 'definitions', 'dependencies', 'not', 'allOf', 'anyOf',
    'oneOf' ];
...
var ALLOWED_SCHEMATA_URLS = {'http://json-schema.org/draft-04/schema#': null};
...
function condenseJsonSchemaRoot( schema ) {
   "use strict";
   if( !schema.hasOwnProperty( '$schema' ) || !ALLOWED_SCHEMATA_URLS.hasOwnProperty( schema.$schema ) ) {
